...
export class Presentation {
  ...
  @Column({ name: "is_missed_followup", default: false, type: "boolean" })
  is_missed_followup: boolean;

  // Push to sales
  @Column({ name: "push_to_sales", default: false, type: "boolean" })
  push_to_sales: boolean;

  @Column({ name: "push_follow_up_to_sales", default: false, type: "boolean" })
  push_follow_up_to_sales: boolean;

  @Column({ name: "confirm_enrollment_followup", default: false, type: "boolean" })
  confirm_enrollment_followup: boolean;
  ...
  @Column({ name: "fk_created_by_user_id", nullable: true, type: "integer" })
